    ...
    ">
      ...
      >
        <motion.a
          target={"_blank"}
          className="w-6 mr-3"
          href="https://hub.docker.com/repositories/shubhamps01"
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.9 }}
          aria-label="Checkout my docker profile"
        >
          <DockerIcon />
        </motion.a>
        <motion.a
          target={"_blank"}
          className="w-6 mx-3"
          href="https://github.com/sangoleshubham20"
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.9 }}
        ...
        <motion.a
          target={"_blank"}
          className="w-6 mx-3"
          href="https://www.linkedin.com/in/shubhamsangole20/"
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.9 }}
        ...
        <motion.a
          ...
          href="https://medium.com/@sangoleshubham20"
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.9 }}
        ...
        <motion.a
          target={"_blank"}
          className="w-6 mx-3"
          href="http://www.youtube.com/@shubhamsangole8279"
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.9 }}
